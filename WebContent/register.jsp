...
<body>
	...
	<form action="solitaire" method="post">
        ...
        <p>Contraseña: <input name="password" type="password" value="${bean.password}" /></p>
        <p>Repetir contraseña: <input name="password2" type="password" value="${bean.user.password}" /></p>
